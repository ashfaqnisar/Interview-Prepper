import config from "src/config/engine.json";
...
export function buildSearchOptionsFromConfig(searchConfig) {
...
export function buildFacetConfigFromConfig(searchConfig) {
  let config = getConfig();
  if (searchConfig) {
    config = searchConfig;
  }
...
export function buildSortOptionsFromConfig(searchConfig) {
  let config = getConfig();
  if (searchConfig) {
    config = searchConfig;
  }
...
export function buildAutocompleteQueryConfig(searchConfig) {
  let config = getConfig();
  if (searchConfig) {
    config = searchConfig;
  }
